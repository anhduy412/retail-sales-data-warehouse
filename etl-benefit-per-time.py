...
#     cursor.execute(
#         f"INSERT INTO [dbo].[benefits_per_time] (shipment_key, category_key, product_key, customer_key, order_key, order_id, department_key, Store_key, date_key, type, order_item_discount, order_item_discount_rate, order_item_product_price, order_item_profit_ratio, order_item_quantity, sales, order_item_total, order_profit_per_order) VALUES ({row.int/float}, '{row.nvarchar}');"
#     )
# conn.commit()
# cursor.close()